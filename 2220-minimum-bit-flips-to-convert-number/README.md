...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-bit-flips-to-convert-number/)
...
**My Solution:** [2220-Minimum-Bit-Flips-to-Convert-Number.cpp](./2220-Minimum-Bit-Flips-to-Convert-Number.cpp)
